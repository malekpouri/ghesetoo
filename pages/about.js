                    ...
                    <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
                        ...
                        <p>
                            <strong>سلام ، <u>درباره سایت</u> رو بصورت مجموعه ای چندین سوال و جواب در خصوص خودم ، تکنیک
                                های فنی
                                سایت و ابزارهایی که برای تولید این سایت استفاده شده قرار دادم و امیدوارم مفید
                                باشه.</strong>
                        </p>
                        <hr/>
                        <h4>چه کسی این سایت رو اداره میکنه؟</h4>
                        <p>من محمد هستم( <a href={'https://utux.ir/'}>utux.ir</a> ) یک توسعه دهنده نرم افزار در ایران
                        </p>
                        ...
                        <p>من این سایت رو برای این راه اندازی کردم که ، افرادی که در هرجایی فعالیت میکنند با بابیان
                            قصه زندگی کاری خودشون مثل روند استخدام ،محیط کاری ، ابزارهایی که استفاده می کنند و اینکه دوست دارن محیط کاریشون چه شکلی باشه به
                        ...
                        <p>من برای فرانت اند از نکست جی اس و برای بک اند از جاوا و اسپرینگ استفاده کردم و چرا که
                            ...
                            <a href={'https://usesthis.com/'}>usesthis.com</a> بوده.</p>
                        <h4>چطور می تونم داستانم رو به اشتراک بزارم ؟</h4>
                        <p>بعد از اینکه داستان خودتون رو نوشتید و به صفحه داستانتون رفتید ، می تونید با ارسال url یا لینک به بقیه اون صفحه رو به اشتراک بزارید</p>
