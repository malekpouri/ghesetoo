...
const mystory = () => {
    ...
    const [bigFileState, setBigFileState] = useState(false);
                    ...
                    <div className={'flex flex-row flex-wrap items-center justify-between pb-2'}>
                        {errors.length !== 0 && (
                            ...
                            >
                                ذخیره
                                <span
                                    className="mx-1 inline-block whitespace-nowrap rounded bg-red-600 py-1 px-1.5 text-center align-baseline text-xs leading-none text-white sm:text-xs md:text-sm ">
                  {errors.length}
                </span>
                            </button>
                        )}
                ...
                >&nbsp;
                  ...
                  >
                    ...
                    ></path>
                        ...
                        {bigFileState && (
                            <span
                                className="mr-3 inline-flex w-auto  items-center shadow-lg rounded-lg bg-red-100 py-2.5 text-xs text-red-600 md:text-base"
                                role="alert"
                                dir={'rtl'}
                            >حجم تصویر بالاست
                  <svg
                    ...
                    <path
                        ...
                        <div
                            className="relative float-left h-24 w-24 drop-shadow-lg duration-300 hover:scale-110 sm:h-36 sm:w-36 md:h-48 md:w-48">
                            <Image
